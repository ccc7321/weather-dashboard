...
// var weatherConditionCard = function(){
//     if (data.weather[0].description = 'clear sky'){
//         var forecastCondition = $('<li class="list-group-item bg-info fa-sun">');
//     }
//         'clear sky': 'fa-sun', // Font Awesome icon class for clear sky
//   'few clouds': 'fa-cloud-sun', // Font Awesome icon class for few clouds
//   'scattered clouds': 'fa-cloud', // Font Awesome icon class for scattered clouds
//   'broken clouds': 'fa-cloud-meatball', // Font Awesome icon class for broken clouds
//   'shower rain': 'fa-cloud-showers-heavy', // Font Awesome icon class for shower rain
//   'rain': 'fa-cloud-rain', // Font Awesome icon class for rain
//   'thunder storm': "fa-cloud-bolt",
//   'snow':"fa-snowflake",
//   'mist':'fa-smog'
